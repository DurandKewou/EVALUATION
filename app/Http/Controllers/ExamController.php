...
class ExamController extends Controller
{
    public function loadExamDashboard($id){
        ...
        if (count($qnaExam)>0) {
           ...
           if ($qnaExam[0]['date'] == date('Y-m-d')) {
            ...
            return view('student.exam-dashboard',['success'=>false,'msg'=>'This Exam has been expired !'.$qnaExam[0]['date'],'exam'=>$qnaExam]);
           }
        }else{
            return view('404');
        }
    ...
    public function reviewQna(Request $request){
        try {
            ...
            return response()->json(['success'=>true,'msg'=>'Qna Data','data'=>$attemptData]);
        } catch (\Exception $e) {
