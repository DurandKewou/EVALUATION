...
<html lang="en">
  ...
  <body>
        ...
        <ul class="list-unstyled components mb-5">
          <li class="active">
            <a href="/admin/dashboard"><span class="fa fa-book mr-3"></span> Subjets</a>
          </li>
          <li class="active">
          ...
          <li class="active">
            <a href="/admin/students"><span class="fa fa-graduation-cap mr-3"></span> User Management(Student)</a>
          </li>
          <li class="active">
            <a href="/admin/review-exam"><span class="fa fa-file-text-o mr-3"></span>Exam Review</a>
          </li>
          <li>
